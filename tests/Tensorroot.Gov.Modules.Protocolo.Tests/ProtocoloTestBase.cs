...
/// <summary>
/// Base de testes de integracao do modulo Protocolo sobre SQLite em memoria:
...
/// </summary>
public abstract class ProtocoloTestBase : IDisposable
{
    ...
    protected ProtocoloTestBase()
    {
        _connection = new SqliteConnection("DataSource=:memory:");
        _connection.Open();
    }

    /// <summary>Cria um <see cref="ProtocoloDbContext"/> no contexto do tenant informado, com auditoria e filtro por tenant.</summary>
    /// <param name="tenantId">Tenant cujo escopo o contexto enxerga.</param>
    /// <returns>Contexto pronto (schema criado).</returns>
    protected ProtocoloDbContext CriarContexto(Guid tenantId)
    {
