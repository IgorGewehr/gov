...
/// <summary>
/// Base de testes de integracao do modulo RecursosHumanos sobre SQLite em memoria: abre uma
...
/// </summary>
public abstract class RecursosHumanosTestBase : IDisposable
{
    ...
    protected RecursosHumanosTestBase()
    {
        _connection = new SqliteConnection("DataSource=:memory:");
        _connection.Open();
    }

    /// <summary>Cria um <see cref="RecursosHumanosDbContext"/> no contexto do tenant informado, com auditoria e filtro por tenant.</summary>
    /// <param name="tenantId">Tenant cujo escopo o contexto enxerga.</param>
    /// <returns>Contexto pronto (schema criado).</returns>
    protected RecursosHumanosDbContext CriarContexto(Guid tenantId)
    {
        ...
        var contexto = new RecursosHumanosDbContext(options, tenantContext);
