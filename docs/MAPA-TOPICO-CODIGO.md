...
| 29 | Processo de suporte e incidentes (`ia-suporte`) | I | Processo/documentação, não código: `docs/governanca/`, `docs/progresso/`, `docs/diagnostico/` (runbook, severidade, post-mortem → vira teste de regressão em `tests/`) |
