namespace Tensorroot.Gov.Modules.Legislativo.Domain;

/// <summary>
/// Módulo Legislativo — Camada de Domínio (agregados, entidades ricas, Value Objects, eventos de domínio, invariantes).
