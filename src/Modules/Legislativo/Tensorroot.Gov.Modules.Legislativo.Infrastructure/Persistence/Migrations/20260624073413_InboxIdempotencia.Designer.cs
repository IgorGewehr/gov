...
namespace Tensorroot.Gov.Modules.Legislativo.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260624073413_InboxIdempotencia")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.Legislativo.Domain.LimiteCamara.ApuracaoArt29A", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("RepasseRecebido")
                        .HasPrecision(18, 2)
                    ...
                    b.ToTable("ApuracoesArt29A", "legislativo");
                });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.Legislativo.Domain.Proposicoes.Proposicao", b =>
                {
                    ...
                    b.Property<bool>("ParecerContrarioCcjSuperado")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Tensorroot.Gov.SharedKernel.InboxMessage", b =>
                {
                    ...
                    b.ToTable("InboxMessages", "legislativo");
                });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.Legislativo.Domain.LimiteCamara.ApuracaoArt29A", b =>
                {
                    b.OwnsOne("Tensorroot.Gov.Modules.Legislativo.Domain.LimiteCamara.ParametrosResolvidosArt29A", "Parametros", b1 =>
                        {
                            b1.Property<Guid>("ApuracaoArt29AId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("ExercicioCorteInativos")
                                .HasColumnType("int")
                                .HasColumnName("ParamExercicioCorteInativos");

                            b1.Property<decimal>("LimiarAtencao")
                                .HasPrecision(9, 6)
                                .HasColumnType("decimal(9,6)")
                                .HasColumnName("ParamLimiarAtencao");

                            b1.Property<decimal>("PercentualFaixa")
                                .HasPrecision(9, 6)
                                .HasColumnType("decimal(9,6)")
                                .HasColumnName("ParamPercentualFaixa");

                            b1.Property<decimal>("SubtetoFolhaSobreRepasse")
                                .HasPrecision(9, 6)
                                .HasColumnType("decimal(9,6)")
                                .HasColumnName("ParamSubtetoFolha");

                            b1.HasKey("ApuracaoArt29AId");

                            b1.ToTable("ApuracoesArt29A", "legislativo");

                            b1.WithOwner()
                                .HasForeignKey("ApuracaoArt29AId");
                        });

                    b.OwnsOne("Tensorroot.Gov.Modules.Legislativo.Domain.LimiteCamara.ReceitaBaseArt29A", "BaseReceita", b1 =>
                        {
                            b1.Property<Guid>("ApuracaoArt29AId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("ExercicioReferencia")
                                .HasColumnType("int")
                                .HasColumnName("BaseExercicioReferencia");

                            b1.Property<decimal>("ReceitaTributaria")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("BaseReceitaTributaria");

                            b1.Property<decimal>("Transferencias")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("BaseTransferencias");
                    ...
                    b.OwnsMany("Tensorroot.Gov.Modules.Legislativo.Domain.LimiteCamara.ItemDespesaCamara", "Despesas", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid>("ApuracaoOwnerId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasIndex("ApuracaoOwnerId");

                            b1.ToTable("ApuracoesArt29ADespesas", "legislativo");

                            b1.WithOwner()
                                .HasForeignKey("ApuracaoOwnerId");
                        });

                    b.Navigation("BaseReceita")
                        .IsRequired();
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.Legislativo.Domain.Proposicoes.Proposicao", b =>
                {
                    b.OwnsMany("Tensorroot.Gov.Modules.Legislativo.Domain.Proposicoes.AprovacaoTurno", "AprovacoesTurno", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<string>("MaioriaAtingida")
                                .IsRequired()
                                .HasMaxLength(20)
                                .HasColumnType("nvarchar(20)");
                            ...
                            b1.HasIndex("ProposicaoOwnerId", "Numero")
                                .IsUnique();

                            b1.ToTable("ProposicoesAprovacoesTurno", "legislativo");
                    ...
                    b.OwnsMany("Tensorroot.Gov.Modules.Legislativo.Domain.Votacoes.Voto", "Votos", b1 =>
                        {
                            ...
                            b1.HasIndex("VotacaoOwnerId", "VereadorId")
                                .IsUnique();
