...
/// <summary>
/// Identificador forte do paciente referenciado pela solicitacao de regulacao (referencia
/// cross-aggregate por Id, sem navegacao). O agregado Paciente reside no mesmo Bounded Context Saude.
/// </summary>
...
/// <summary>
/// Identificador forte do estabelecimento (CNES) solicitante (referencia cross-aggregate
/// por Id, sem navegacao).
/// </summary>
/// <param name="Value">Valor GUID subjacente.</param>
...
/// <summary>
/// Identificador forte do profissional solicitante (referencia cross-aggregate
/// por Id, sem navegacao).
/// </summary>
/// <param name="Value">Valor GUID subjacente.</param>
