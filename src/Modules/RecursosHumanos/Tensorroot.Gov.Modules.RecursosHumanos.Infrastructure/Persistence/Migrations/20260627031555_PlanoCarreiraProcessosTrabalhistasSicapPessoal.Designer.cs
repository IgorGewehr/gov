...
namespace Tensorroot.Gov.Modules.RecursosHumanos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260627031555_PlanoCarreiraProcessosTrabalhistasSicapPessoal")]
    partial class PlanoCarreiraProcessosTrabalhistasSicapPessoal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.PlanoCarreira.EnquadramentoServidor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ClasseAtual")
                        .HasColumnType("int");

                    b.Property<Guid>("PlanoCarreiraId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ReferenciaAtual")
                        .HasColumnType("int");
                    ...
                    b.ToTable("EnquadramentosCarreira", "recursoshumanos");
                });

            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.PlanoCarreira.PlanoCarreira", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("DenominacaoCarreira")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<int>("IntersticioMeses")
                        .HasColumnType("int");

                    b.Property<string>("LeiInstituicao")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<decimal>("NotaMinimaProgressao")
                        .HasColumnType("decimal(5,2)");

                    b.Property<int>("NumeroClasses")
                        .HasColumnType("int");

                    b.Property<int>("NumeroReferencias")
                        .HasColumnType("int");

                    b.Property<decimal>("PercentualEntreClasses")
                        .HasColumnType("decimal(7,4)");

                    b.Property<decimal>("PercentualEntreReferencias")
                        .HasColumnType("decimal(7,4)");
                    ...
                    b.Property<decimal>("VencimentoBase")
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.ToTable("PlanosCarreira", "recursoshumanos");
                });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.ProcessosTrabalhistas.ProcessoTrabalhista", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateOnly>("DataAjuizamento")
                        .HasColumnType("date");
                    ...
                    b.Property<decimal?>("ValorAcordo")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("TenantId", "Situacao", "Prognostico");

                    b.ToTable("ProcessosTrabalhistas", "recursoshumanos");
                });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.SicapPessoal.RemessaSicapPessoal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("CodigoOrgao")
                        .HasColumnType("int");

                    b.Property<DateOnly>("DataGeracaoLote")
                        .HasColumnType("date");

                    b.Property<DateTimeOffset?>("GeradaEm")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("ProtocoloTransmissao")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("SequencialLote")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "CodigoOrgao", "SequencialLote")
                        .IsUnique();

                    b.ToTable("RemessasSicapPessoal", "recursoshumanos");
                });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.PlanoCarreira.EnquadramentoServidor", b =>
                {
                    b.OwnsMany("Tensorroot.Gov.Modules.RecursosHumanos.Domain.PlanoCarreira.MovimentacaoCarreira", "Movimentacoes", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("ClasseDestino")
                                .HasColumnType("int");

                            b1.Property<int?>("ClasseOrigem")
                                .HasColumnType("int");

                            b1.Property<string>("Criterio")
                                .HasMaxLength(30)
                                .HasColumnType("nvarchar(30)");

                            b1.Property<DateOnly>("DataEfeito")
                                .HasColumnType("date");

                            b1.Property<Guid>("EnquadramentoServidorId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<Guid?>("PortariaId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("ReferenciaDestino")
                                .HasColumnType("int");

                            b1.Property<int?>("ReferenciaOrigem")
                                .HasColumnType("int");
                            ...
                            b1.Property<decimal>("VencimentoResultante")
                                .HasColumnType("decimal(18,2)");

                            b1.HasKey("Id");

                            b1.HasIndex("EnquadramentoServidorId");

                            b1.ToTable("MovimentacoesCarreira", "recursoshumanos");

                            b1.WithOwner()
                                .HasForeignKey("EnquadramentoServidorId");
                        });
            ...
            modelBuilder.Entity("Tensorroot.Gov.Modules.RecursosHumanos.Domain.SicapPessoal.RemessaSicapPessoal", b =>
                {
                    b.OwnsMany("Tensorroot.Gov.Modules.RecursosHumanos.Domain.SicapPessoal.AtoAdmissaoSicap", "Atos", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("CargaHorariaSemanal")
                                .HasColumnType("int");

                            b1.Property<int?>("ClassificacaoConcurso")
                                .HasColumnType("int");
                            ...
                            b1.Property<DateOnly>("DataAto")
                                .HasColumnType("date");

                            b1.Property<DateOnly?>("DataHistorica")
                                .HasColumnType("date");

                            b1.Property<DateOnly>("DataNascimento")
                                .HasColumnType("date");

                            b1.Property<DateOnly?>("DataTermino")
                                .HasColumnType("date");

                            b1.Property<string>("DescricaoCargo")
                                .IsRequired()
                                .HasMaxLength(70)
                                .HasColumnType("nvarchar(70)");

                            b1.Property<string>("IdentificadorAto")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");

                            b1.Property<string>("MotivoExtincao")
                                .HasMaxLength(40)
                                .HasColumnType("nvarchar(40)");
                            ...
                            b1.Property<Guid>("RemessaSicapPessoalId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid?>("ServidorId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<string>("TipoAto")
                                .IsRequired()
                                .HasMaxLength(40)
                                .HasColumnType("nvarchar(40)");
                            ...
                            b1.HasIndex("RemessaSicapPessoalId");

                            b1.ToTable("AtosAdmissaoSicap", "recursoshumanos");

                            b1.WithOwner()
                                .HasForeignKey("RemessaSicapPessoalId");
                        });
