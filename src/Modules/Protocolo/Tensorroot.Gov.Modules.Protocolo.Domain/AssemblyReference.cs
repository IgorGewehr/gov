namespace Tensorroot.Gov.Modules.Protocolo.Domain;

/// <summary>
/// Módulo Protocolo — Camada de Domínio (agregados, entidades ricas, Value Objects, eventos de domínio, invariantes).
