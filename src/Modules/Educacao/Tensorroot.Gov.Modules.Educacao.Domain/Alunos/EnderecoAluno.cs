...
/// <summary>
/// Endereco residencial do aluno (owned type): logradouro, numero, bairro, municipio, UF e CEP.
/// Distinto do <c>ValueObjects.Endereco</c> da escola (que carrega georreferenciamento para rotas de
/// transporte): o endereco do aluno e cadastral/residencial. Objeto de valor imutavel.
/// </summary>
public readonly record struct EnderecoAluno
{
    /// <summary>Quantidade exata de caracteres de uma UF.</summary>
    public const int ComprimentoUf = 2;

    /// <summary>Cria um endereco residencial do aluno.</summary>
    ...
    public EnderecoAluno(string logradouro, string numero, string bairro, string municipio, string uf, string cep)
    {
