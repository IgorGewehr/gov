namespace Tensorroot.Gov.Modules.Educacao.Domain;

/// <summary>
/// Módulo Educacao — Camada de Domínio (agregados, entidades ricas, Value Objects, eventos de domínio, invariantes).
