namespace Tensorroot.Gov.Modules.AssistenciaSocial.Application;

/// <summary>
/// Módulo AssistenciaSocial — Camada de Aplicação (Commands, Queries, Handlers MediatR, Validators, ports).
