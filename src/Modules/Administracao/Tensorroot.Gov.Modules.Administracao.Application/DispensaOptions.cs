...
/// tenant. Os DEFAULTS espelham o Dec. 12.343/2024 (vigencia 01/01/2025), mas TODOS sao
/// sobrescrititiveis por configuracao do tenant (CLAUDE.md §7/§16) — os valores sao atualizados
/// anualmente em 1 de janeiro pelo IPCA-E (art. 182), entao NUNCA vivem no codigo do agregado.
/// O prazo minimo de divulgacao do aviso de contratacao direta (IN SEGES/ME 67/2021; art. 75 §3) tambem
/// e parametrizavel.
/// </summary>
public sealed class DispensaOptions
{
    ...
    /// Default: Dec. 12.343/2024 (R$ 125.451,15).
    /// </summary>
    public decimal LimiteObrasEngenharia { get; set; } = 125_451.15m;

    /// <summary>
    /// Limite de dispensa para outros servicos e compras (art. 75, II).
    /// Default: Dec. 12.343/2024 (R$ 62.725,59).
    /// </summary>
    public decimal LimiteOutrosServicosCompras { get; set; } = 62_725.59m;

    /// <summary>Norma-fonte dos limites aplicados (rastreabilidade da parametrizacao).</summary>
    public string LimiteNormaFonte { get; set; } = "Lei 14.133/2021 art. 75, I/II; Dec. 12.343/2024";
