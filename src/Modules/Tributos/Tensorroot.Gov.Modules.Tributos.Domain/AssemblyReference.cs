namespace Tensorroot.Gov.Modules.Tributos.Domain;

/// <summary>
/// Módulo Tributos — Camada de Domínio (agregados, entidades ricas, Value Objects, eventos de domínio, invariantes).
